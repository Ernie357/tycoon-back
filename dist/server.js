...
const generateHash = (playerName, roomCode, secret) => {
    return crypto_1.default.createHmac('sha256', secret).update(`${playerName}:${roomCode}`).digest('hex');
};
